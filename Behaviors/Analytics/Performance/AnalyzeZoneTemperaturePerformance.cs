...
namespace LisaCore.Behaviors.Analytics.Performance
{
    ...
    public class AnalyzeZoneTemperaturePerformance : BrickBehavior
    {
        ...
        public AnalyzeZoneTemperaturePerformance(AnalyticsResultFunction analyticsResultCallBackFuntion, double deadband, int intervalMinute = 15)
            : base("Zone Temperature Efficiency", typeof(AnalyzeZoneTemperaturePerformance).Name)
        {
                                ...
                                if (temperatureData.Count > 0)
                                {
                                    try
                                    {
                                        ...
                                        if (result.Count > 0)
                                        {
                                            ...
                                            item.Status = ResultStatusesEnum.Success;
                                        ...
                                        else
                                        {
                                            results.Add(new()
                                            {
                                                ...
                                                Status = ResultStatusesEnum.Failure
                            ...
                            else
                            {
                                if (NotifyError("NoTempSpHistory"))
                                {
                                    results.Add(new()
                                    {
                                        ...
                                        Status = ResultStatusesEnum.Skipped
